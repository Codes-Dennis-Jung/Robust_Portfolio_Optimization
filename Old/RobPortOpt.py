...
class RobustEfficientFrontier(PortfolioOptimizer):
    def __init__(
        ...
        self._align_epsilon_and_alpha(returns, epsilon, alpha)
    ...
    def _align_epsilon_and_alpha(self, returns: pd.DataFrame, epsilon: Optional[Union[pd.DataFrame, float, np.ndarray]], alpha: Optional[Union[pd.DataFrame, float, np.ndarray]]):
